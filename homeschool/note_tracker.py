...
class NoteTracker:
    ...
    def __init__(self, tracker_path: Optional[Path] = None):
        ...
        """
        self._tracker_path = tracker_path or (Path.home() / ".sovereign_brain" / "manifest" / "note_tracker.json")
...
AUDIT_LOG_PATH = Path.home() / ".sovereign_brain" / "manifest" / "audit_log.jsonl"
